...
export default {
  ...
  created: function () {
    axios
      .get(
        "https://api.themoviedb.org/3/discover/movie?api_key=65a8344a59a4de14be662219b6d648cc&sort_by=vote_count.desc&language=fr&page=1"
      )
      .then((response) => {
        ...
        axios
          .get(
          "https://api.themoviedb.org/3/discover/movie?api_key=65a8344a59a4de14be662219b6d648cc&sort_by=vote_count.desc&language=fr&page2"
          )
          .then((response) => {
    ...
    getMoviesByGenre(nbr) {
      axios
        .get(
          "https://api.themoviedb.org/3/discover/movie?api_key=65a8344a59a4de14be662219b6d648cc&sort_by=vote_count.desc&with_genres=" + nbr
        )
        .then((results) => {
