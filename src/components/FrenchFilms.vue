...
export default {
  ...
  created: function () {
    axios
      .get(
        "https://api.themoviedb.org/3/discover/movie?api_key=65a8344a59a4de14be662219b6d648cc&query=m&with_original_language=fr&region=FR&language=fr&page=1"
      )
      .then((response) => {
        ...
        axios
          .get(
            "https://api.themoviedb.org/3/discover/movie?api_key=65a8344a59a4de14be662219b6d648cc&query=m&with_original_language=fr&region=FR&language=fr&page=2"
          )
          .then((response) => {
  ...
  methods: {
    getMoviesByGenre(nbr) {
      axios
        .get(
          "https://api.themoviedb.org/3/discover/movie?api_key=65a8344a59a4de14be662219b6d648cc&with_original_language=fr&region=FR&with_genres=" +
            nbr
        )
        .then((results) => {
